...
//My Page
export const SamplePage = loadable(() => import("./MyPage/SamplePage"), {
  fallback: <Loading />,
});
...
//Master Page
export const PetType = loadable(() => import("./MasterData/PetType"), {
  fallback: <Loading />,
});

export const PetBreed = loadable(() => import("./MasterData/PetBreed"), {
  fallback: <Loading />,
});
